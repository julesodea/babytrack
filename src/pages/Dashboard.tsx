    ...
    <div className="space-y-10">
      ...
      <div className="space-y-6 pt-4">
        ...
        <div className="bg-transparent">
          ...
          {/* Pagination Controls */}
          {totalPages > 1 && (() => {
            // Generate page numbers to display (max 4 page number buttons)
            const getPageNumbers = () => {
              ...
              if (currentPage <= 3) {
                ...
                // Near the end: show 1, ..., and last 3 pages (4 total page numbers)
                pages.push(1);
                pages.push("ellipsis");
                ...
                // In the middle: show exactly 4 page numbers around current
                // Show: 1, current-1, current, current+1 (4 numbers)
                pages.push(1);
                if (currentPage > 3) {
                  pages.push("ellipsis");
                }
